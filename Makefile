IMAGE = git.project-hobbit.eu:4567/ldcbench/ldcbench-apache-nutch-adapter
...
add-hobbit-remote:
	git remote |grep hobbit ||git remote --verbose add hobbit https://git.project-hobbit.eu/ldcbench/ldcbench-apache-nutch-adapter
